...
| Clean statement failure | Errors do not tear down a usable connection; unsupported statements map to `0A000`. | `wire_client_gets_clean_errors_and_rejects_unsupported_sql` |
