...
- PostgreSQL-wire syntax errors now map to SQLSTATE `42601`; parameter-shape
  ...
  `42P01` and `42703`, respectively; single-table grouping validation maps to
  `42803`; datatype mismatches map to `42804`; division by zero, numeric
  overflow, and not-null violations map to `22012`, `22003`, and `23502`.
  Regression coverage remains alongside the existing `0A000`
