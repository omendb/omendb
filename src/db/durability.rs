...
//!
//! This module owns blob reservation, publication-capacity preflight,
//! manifest-history and reuse-ledger artifact persistence, and manifest
//! mirroring. WAL admission and journaling live in `wal_admission.rs`.
//! `DB` remains the mutable state owner; `publication.rs` remains the
//! publication-ordering authority.
...
use super::{
    ...
    PUBLICATION_CAPACITY_SAFETY_BYTES, REUSE_LEDGER_FILE, Result,
};
