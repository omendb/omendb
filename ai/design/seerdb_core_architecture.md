...
`seerdb` is a high-performance, embedded LSM-tree storage engine written in Rust. It is a general-purpose key-value store optimized for graph and vector workloads.
