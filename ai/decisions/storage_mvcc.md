...
**Status**: Accepted
**Context**: Graph workloads require Snapshot Isolation for consistent traversals and atomic transactions.
...
Implement MVCC in application layer by appending versions to keys manually.
